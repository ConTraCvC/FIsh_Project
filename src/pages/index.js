...
export const getServerSideProps = async() => {
  ...
  return {
    props: { new_props, tech_props, food_props, fish_SX_props, fish_TN_props}};
};

export default function Home({new_props, tech_props, food_props, fish_SX_props, fish_TN_props}) {
  return (
